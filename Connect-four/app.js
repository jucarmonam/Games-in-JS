const squares = document.querySelectorAll('.grid div');  //obtenemos todos los div con clase grid
...
for(var i=0, len = squares.length; i < len; i++){
    ...
    (function(index){ //funcion anonima a la cual no le ponemos nombre y esta metida dentro de un parentesis por lo tanto nunca es llamada, el index solo es el parametro de entrada que es llamado mas adelante
    ...
    })(i)//en esta parte llamamos a la funcion anonima i veces osea en el index se pone i, osea con el i del for se va llamando a la funcionv varias veces
