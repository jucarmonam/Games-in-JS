...
const width = 9;
let currentIndex = 76;  //donde empieza el frog
let currentTime = 20;
let timerId;
...
function win(){
    if(squares[4].classList.contains('frog')){  //4 porque es el cuadro exacto donde se gana
...
//move the frog when tis on the log moving left
...
//move the frog when tis on the log moving right
